    ...
    emailAndPassword: {
        ...
        async sendResetPassword({ user, url, token }) {
            ...
            await transporter.sendMail({
                ...
                to: user.email,
                subject: 'Resetiranje lozinke - Rent a webica',
                html: `
                    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #333;">
                        <h2 style="color: #22c55e;">Resetirajte svoju lozinku</h2>
                        <p>Primili smo zahtjev za resetiranje lozinke za vaš Rent a webica račun.</p>
                        ...
                        <p style="color: #999; font-size: 12px;">Rent a webica tim</p>
                    </div>
                `,
            });
        },
