...
- **Plaćanje**: [Stripe](https://stripe.com/)
- **Domenama upravlja**: Vercel API
- **AI Integracija**: Google Gemini (za generiranje sadržaja i ideja)


**Autor**: Jurica Stublić
**Kontakt**: jurica@webica.hr
