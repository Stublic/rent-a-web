...
import { Shield, Users, FolderOpen, FileText, BarChart3, LogOut, MessageSquare, Menu, X, Image, Settings, Ticket, Megaphone, Bug } from 'lucide-react';
...
export default function AdminLayout({ children }) {
    ...
    const navItems = [
        ...
        { href: '/admin/bug-reports', icon: Bug, label: 'Bug Reportovi' },
