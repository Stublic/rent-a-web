          ...
          <FadeIn>
            ...
            <div className="max-w-2xl mx-auto">
              <form netlify
                ...
                data-netlify="true" 
                action="/success"
                className="space-y-6 bg-black/50 backdrop-blur-sm p-8 rounded-3xl border border-zinc-800 shadow-2xl"
              >
                ...
                <button type="submit" className="w-full bg-green-600 hover:bg-green-500 text-white font-bold py-4 rounded-xl transition-all transform hover:scale-[1.01] shadow-lg shadow-green-900/20 flex items-center justify-center gap-2">
