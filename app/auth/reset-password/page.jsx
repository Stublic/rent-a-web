    ...
    return (
        <div className="min-h-screen bg-black flex items-center justify-center p-6 relative overflow-hidden">
            ...
            <div className="w-full max-w-md relative z-10">
                ...
                <Suspense fallback={
                    <div className="bg-zinc-900/50 backdrop-blur-xl border border-zinc-800 p-8 rounded-3xl shadow-2xl flex flex-col items-center justify-center space-y-4 min-h-[400px]">
                        <Loader2 className="w-12 h-12 text-green-500 animate-spin" />
                        <p className="text-zinc-400 animate-pulse font-medium">Provjera linka...</p>
                    </div>
                }>
                    <ResetPasswordForm />
                </Suspense>
